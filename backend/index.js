const apiKey = "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";
...
//CORS 이슈 해결
let corsOptions = {
  origin: "https://chatdozi-theokim.pages.dev/",
  credentials: true,
};
...
app.post("/fortuneTell", async function (req, res) {
  ...
  let messages = [
    ...
    {
      role: "assistant",
      content: `당신의 생년월일과 태어난 시간은 ${myDateTime}인 것과 오늘은 ${todayDateTime}인 것을 확인하여씁니다. 운세에 대해서 어떤 것이든 무엇이든 물어보세요.`,
    },
  ];
